...
function onKeyPress(button) {
    kbTimeout.reset();
    myKeyboard.addButtonTheme(button, 'pressed'); keyPressed = button;
...
function onKeyReleased(button){
    ...
    if (keyPressed != ""){
        myKeyboard.removeButtonTheme(keyPressed, 'pressed');
        keyPressed = "";
    }
